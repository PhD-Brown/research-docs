  ...
  homeSidebar: [
    ...
    { type: "doc", id: "reading-paths", label: "Reading Paths" },
    {
      ...
      items: [
        ...
        "atlas/acronyms",
        "atlas/methods-index",
        { type: "doc", id: "atlas/claims-register", label: "⚖️ Claims Register" },
        "atlas/datasets-index",
        "atlas/figures-index",
        "atlas/notebook-atlas",
  ...
  astrospectroSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { type: "doc", id: "astrospectro/concepts/data-leakage-audit", label: "Data Leakage Audit" },
    ...
    },
    {
      ...
      items: [
        ...
        { type: "doc", id: "astrospectro/science/model-card", label: "🃏 Model Card — XGBoost" },
